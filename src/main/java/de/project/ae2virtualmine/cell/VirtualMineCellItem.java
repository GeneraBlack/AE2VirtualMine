...
public class VirtualMineCellItem extends Item implements ICellWorkbenchItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display, Consumer<Component> lines, TooltipFlag flag) {
        ...
        if (cell instanceof VirtualMineCellInventory mineInv) {
            lines.accept(Tooltips.bytesUsed(mineInv.getUsedBytes(), mineInv.getTotalBytes()));
            lines.accept(Tooltips.typesUsed(mineInv.getStoredItemTypes(), mineInv.getTotalItemTypes()));
        } else {
